//dot2apcmini v 1.0.7 require easymidi & websocket
...
input.on('noteon', function (msg) {
    ...
    if (msg.note == 98) { //SHIFT ON
        ...
        if (ledmatrix[pageIndex] != 3) {
            ledmatrix[pageIndex] = 3;
    ...
    if (shift == 1) {
        if (msg.note < 64) {
            if (ledmatrix[pageIndex] != 0) {
                ledmatrix[pageIndex] = 0;
